  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-[#050708] text-white selection:bg-green-400/30">
        ...
        <div className="p-4 sm:p-6 lg:p-8 md:ml-[260px]">
    ...
    <main className="min-h-screen bg-[#050708] text-white selection:bg-green-400/30">
      ...
      <div className="relative min-h-screen overflow-hidden md:ml-[260px]">
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-white/35">
                Team identity, leadership and competitive roster.
              </p>
            </div>

            {data.session.isOwner && (
              <button
                type="button"
        ...
        <div className="relative z-10 mx-auto max-w-7xl space-y-8 p-4 sm:p-6 lg:p-8">
          <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-green-400/[0.07] via-white/[0.025] to-transparent shadow-2xl">
            <div className="p-8">
              <div className="flex flex-col gap-6 md:flex-row md:items-center">
                <div className="flex h-32 w-32 shrink-0 items-center justify-center overflow-hidden rounded-3xl border border-green-400/15 bg-black/40 shadow-[0_0_35px_rgba(74,222,128,0.08)]">
                  {data.team.logoUrl ? (
                    <img
          ...
          <section>
            <div className="mb-4 flex items-end justify-between">
              ...
              <Link
                href="/team/roster"
                className="text-sm font-bold text-green-400 hover:text-cyan-300"
              >
                Manage Roster →
              </Link>
            </div>
            ...
            <section>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {staff.map((member) => (
                  <div
                    key={member.id}
                    className="rounded-2xl border border-white/10 bg-white/[0.025] p-5 transition hover:border-green-400/20 hover:bg-white/[0.04]"
                  >
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-black/80 p-3 backdrop-blur-md sm:p-5">
          <div className="my-auto w-full max-w-xl rounded-2xl border border-white/10 bg-[#0b0f0e] p-6">
...
function PersonCard({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.025] p-5 transition hover:border-green-400/20 hover:bg-white/[0.04]">
      <p className="text-xs font-bold uppercase tracking-wider text-white/30">
        {label}
      </p>
      ...
      {person ? (
        <div className="mt-4 flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-green-400/15 bg-green-400/10 font-black text-green-300 shadow-[0_0_24px_rgba(74,222,128,0.10)]">
            {person.displayName
              .charAt(0)
              .toUpperCase()}
          </div>
...
function PlaceholderCard({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.025] p-6 transition hover:border-green-400/20 hover:bg-white/[0.04]">
      <p className="text-xs font-bold uppercase tracking-wider text-white/30">
        COMING SOON
      </p>
